 ...
 * @author Admin
 */
public class PanelScreen extends javax.swing.JFrame {

    /**
     * Creates new form PanelScreen
     */
   // UserLogin user = new UserLogin();
    public PanelScreen(){
        initComponents();
        this.setTitle("Railway Reservation System");
        ...
        jLabel2.setText("Welcome"+" "+UserLogin.name);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome to Reservation Center");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PanelScreen().setVisible(true);
            }
        });
    }
